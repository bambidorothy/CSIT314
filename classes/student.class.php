        ...
        if ($result) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<tr>
                  ...
                  <td>'.$time.'</td>
                  <td>'.$status.'</td>
                  <td><a type="submit" href="closePost.php?id='.$post_id.'" id="closePostBtn" class="btn btn-danger" style="width:8em;">Mark Closed</a></td>
                  <td><a type="submit" href="detailPost.php" id="viewPostBtn" class="btn btn-primary" style="width:7em;">View Post</a></td>
              </tr>';
            }
        }
    }
