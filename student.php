        ...
        <div class="row">
            <div class="col">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <a class="nav-item nav-link active" id="nav-createpost-tab" data-toggle="tab"
                            href="#nav-createpost" role="tab" aria-controls="nav-createpost" aria-selected="true">Create
                            Post</a>
                        ...
                        <a class="nav-item nav-link" id="nav-manage-post" data-toggle="tab" href="#nav-managepost"
                            role="tab" aria-controls="nav-managepost" aria-selected="false">View/Manage Posts</a>
                        <a class="nav-item nav-link" id="nav-search-post" data-toggle="tab" href="#nav-searchpost"
                            role="tab" aria-controls="nav-searchpost" aria-selected="false">Search Post</a>
                    </div>
                </nav>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="nav-createpost" role="tabpanel"
                        aria-labelledby="nav-createpost-tab">
                    ...
                    <div class="tab-pane fade" id="nav-searchpost" role="tabpanel" aria-labelledby="nav-search-post">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <textarea rows="5" cols="5" type="text" class="form-control"
                                    name="searchValue"></textarea>
                            </div>
                            <div class="form-group">
